...
Servo door;
bool doorState, fan1State, fan2State, light1State, light2State, enrollFlag, enrollDone, delFingerprintData, enrollError, delFingerError = false; // States are edited only twice by firmware in 1 class session, the rest is managed by GUI
int student_number;
